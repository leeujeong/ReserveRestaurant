...
CREATE TABLE menu (
    ...
    menu_discount_rate     	NUMBER(4),

    menu_expiry_date       	VARCHAR2(13 BYTE),
...
CREATE TABLE reply (
    ...
    reply_title            	VARCHAR2(100 BYTE),

    reply_content          	VARCHAR2(2000 BYTE),

    reply_date       		DATE,

    reply_lastmodified     	DATE,
...
ALTER TABLE reply
    ...
    ADD CONSTRAINT reply_notice_fk FOREIGN KEY ( notice_no )
...
ALTER TABLE reply
    ...
    ADD CONSTRAINT reply_review_fk FOREIGN KEY ( review_no )
