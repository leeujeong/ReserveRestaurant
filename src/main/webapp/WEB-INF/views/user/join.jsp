...
<header class="shareit_header"> 
      <div>
        <a class="header-logo" href="메인페이지로 이동"><img src="/restaurant/resources/image/join/FindTableLogo.png" alt="shareit-logo"></a> 
        <a class="header-logo1" href="메인페이지로 이동"><img src="/restaurant/resources/image/join/rightaway.svg" alt="쉐어잇바로가기">&nbsp;&nbsp;메인화면으로 가기</a> 
     </div>
</header>
<div style="
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="text" class="inTxt rs-w100" id="user_name" name="user_name" value="" maxlength="50" style="width:180px" title="성명 입력"> <!--  -->
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="selectboxWrap">
                                <select class="select selectBg" id="user_hbd" name="user_hbd" title="년도 선택">
                            ...
                            <span class="selectboxWrap">
                                <select class="select selectBg" id="user_hbd" name="user_hbd" title="월 선택">
                            ...
                            <span class="selectboxWrap" style="width:32%">
                                <select class="select selectBg" id="user_hbd" name="user_hbd" title="일 선택">
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="hp">
                            <span class="selectboxWrap">
                                <select class="select selectBg" id="user_tel" name="user_tel" title="휴대폰 번호 선택">
                            ...
                            <input type="text" class="inTxt" id="user_tel" name="user_tel" maxlength="4" onkeydown="only_number(this)" style="width:80px" title="휴대폰 두번째 자리 입력">
                            <span class="dash">-</span>
                            <input type="text" class="inTxt" id="user_tel" name="user_tel" maxlength="4" onkeydown="only_number(this)" style="width:80px" title="휴대폰 세번째 자리 입력">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3" class="email">
                            ...
                            <input type="text" class="inTxt rs-w40" id="user_email" name="user_email" onfocus="checkLen(this.value);" style="width:200px;ime-mode:disabled;" title="이메일 아이디 입력">
                            <span class="dash">  </span>
                            <!-- 
	                            <input type="text" class="inTxt rs-w45" id="user_email" name="user_email" onfocus="checkLen(this.value);" onblur="checkMail(this.value);" style="width:120px;ime-mode:disabled;" title="이메일 입력">
	                            <span class="selectboxWrap" style="width:180px">
                            -->
                           
                            <!-- 
                                <select class="select selectBg" id="user_email" name="user_email" onchange="chgEmail(this.value, this.selectedIndex);" style="width:120px;ime-mode:disabled;"  title="이메일 선택">
                    ...
                    <tr>
                        <th scope="row"><label for="mailKey">이메일<br>인증확인</label><span class="essR">필수</span></th>
                        <td colspan="3">
