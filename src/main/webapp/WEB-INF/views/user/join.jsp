...
<header class="shareit_header"> 
      <div>
        ...
        <a class="header-logo1" href="/restaurant"><img src="/restaurant/resources/image/join/rightaway.svg" alt="쉐어잇바로가기">&nbsp;&nbsp;메인화면으로 가기</a> 
     </div>
</header>
<div style="
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="text" class="inTxt rs-w100" id="userName" name="userName" value="" maxlength="50" style="width:180px" title="성명 입력"> <!--  -->
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="selectboxWrap">
                                <select class="select selectBg" id="userHbd" name="userHbd" title="년도 선택">
                            ...
                            <span class="selectboxWrap">
                                <select class="select selectBg" id="userHbd" name="userHbd" title="월 선택">
                            ...
                            <span class="selectboxWrap" style="width:32%">
                                <select class="select selectBg" id="userHbd" name="userHbd" title="일 선택">
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="hp">
                            <span class="selectboxWrap">
                                <select class="select selectBg" id="userTel" name="userTel" title="휴대폰 번호 선택">
                            ...
                            <input type="text" class="inTxt" id="userTel" name="userTel" maxlength="4" onkeydown="only_number(this)" style="width:80px" title="휴대폰 두번째 자리 입력">
                            <span class="dash">-</span>
                            <input type="text" class="inTxt" id="userTel" name="userTel" maxlength="4" onkeydown="only_number(this)" style="width:80px" title="휴대폰 세번째 자리 입력">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3" class="email">
                            ...
                            <input type="text" class="inTxt rs-w40" id="userEmail" name="userEmail" onfocus="checkLen(this.value);" style="width:200px;ime-mode:disabled;" title="이메일 아이디 입력">
                            <span class="dash">  </span>
                            <!-- 
