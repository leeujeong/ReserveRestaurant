  ...
  <div class="accordion">
   ...
   <section class="review_aver_section">
	...
	<form id="f" method="post">
       ...
       <textarea class="summernote" placeholder="수정할 내용을 입력해주세요" 
        name="editordata" id="summernote">${qnaBoardDetail.qnaContent}</textarea><br><br>
       </div>
       <input type="hidden" name="no" value="${qnaBoardDetail.qnaNo}">
